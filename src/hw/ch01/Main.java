...
public class Main {
    public static void main(String[] args) {
        ...
        Iterator<Book> itYear = bookShelf.iteratorByYearDesc();

        while (itYear.hasNext()) {
            Book book = itYear.next();
