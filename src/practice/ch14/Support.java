...
public abstract class Support {
    ...
    private Support next;   // 떠넘길 곳(Support: 부모 타임 => 모든 종류의 해결자들을 기리킬 수 있다.)
    ...
    // 해결하려고 한다
    protected abstract boolean resolve(Trouble trouble);    // 자식들이 해결 방법을 구현함
